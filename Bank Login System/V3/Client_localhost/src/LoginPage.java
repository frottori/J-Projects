...
public class LoginPage implements ActionListener {
    ...
    JFrame balanceWindow,accountWindow, forum, frame;
    ...
    LoginPage() { 
        ...
        //Account Information
        user = new AccountField("username :",35,10,110,50,100,100,300,20);
        ...
        value = new AccountField(0,10000,10);
        ...
        passwordLabel.setBounds(35,40,100,100);
        passwordLabel.setForeground(Color.WHITE);
        passwordLabel.setFont(new Font("Helvetica",Font.PLAIN,15));
        
        ImageIcon check = new ImageIcon(getClass().getResource("/icons/checked.png")); 
        ImageIcon uncheck = new ImageIcon(getClass().getResource("/icons/unchecked.png")); 
        ...
        signIn.setBounds(200,105,90,33);
        signIn.setFocusable(false);
        signIn.addActionListener(this);

        signUp.setBounds(300,105,90,33);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource()==signIn) {
            if(info.getLoginInfo().containsKey(username)) {
                if(info.getLoginInfo().get(username).equals(password)) {
                    ...
                    logOut.setBounds(120,170,90,33);
                    logOut.setFocusable(false);
                    withdraw.setBounds(225,170,90,33);
                    withdraw.setFocusable(false);
                    deposit.setBounds(330,170,90,33);
        ...
        if (e.getSource()==signUp) {
            if (!info.getLoginInfo().containsKey(username) && !user.getField().getText().equals(""))  {  
                ...
                register.setBounds(330,135,90,33);
        ...
        if(e.getSource()==register) {
            ...
            if (!fname.getField().getText().equals("") && !lname.getField().getText().equals("") ) {
                    ...
                    // ? INSERT NEW BANK MEMBER
                    info.insertDB(
                    username,
                    password,
                    fname.getField().getText(),
                    lname.getField().getText(),
                    (String) genderbox.getBox().getSelectedItem()
                    );
        ...
        if (e.getSource()==withdrawValue || e.getSource()==depositValue){
            ...
            if (action.equals("Withdraw")){
                ...
                val =  initval - x;
                if (val<0){
                    ImageIcon icon = new ImageIcon(getClass().getResource("/icons/warning.png"));
            ...
            // ? UPDATE BALANCE
            info.updateDB(username, (float) val);
